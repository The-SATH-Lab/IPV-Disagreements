...
#     x = x.lower()
#     if ('romantic partner' in x) or ('partner' in x) or ('romantic' in x):
#         return 'Romantic Partner'
#     if ('friend' in x) or ('important person' in x):
#         return 'Friend'
#     if ('father' in x) or ('mother' in x) or ('parent' in x) or ('dad' in x) or ('mom' in x):
...
# message_types = ["VIDEO", "IMAGE", "ATTACHMENT"]
