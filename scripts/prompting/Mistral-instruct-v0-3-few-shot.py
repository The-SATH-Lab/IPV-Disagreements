...
from sklearn.metrics import (accuracy_score, classification_report, 
                             confusion_matrix, balanced_accuracy_score, f1_score, recall_score)
...
def generate_test_prompt(text, few_shot_examples):
    return f"""
    You’re an expert at analyzing conversations between romantic partners.
    Go through the conversations and corresponding labels provided below to get a sense of the conversations and later classify a new conversation to determine 
    if there is a disagreement or not, and you must return the answer as the corresponding label Yes or No. Do not add anything else.
    -------------------------------------------------------------------------------------
    Examples:
    {few_shot_examples}
    ------------------------------------------------------------------------------------
    ...
    Now, determine if there is a disagreement or not in the above conversation, and return the answer as
    the corresponding label Yes or No. Do not add anything else.
    label: 
    """.strip()
