...
# MODELING_SNAP_DIR = os.path.join(DATA_DIR, "modeling", "SNAP")
# MODELING_SOCIAL_DIR = os.path.join(DATA_DIR, "modeling", "SOCIAL")

SAVED_EMBEDDINGS_DIR = os.path.join(DATA_DIR, "saved_embeddings")
SAVED_EMBEDDINGS_SNAP_DIR = os.path.join(SAVED_EMBEDDINGS_DIR, "SNAP")
SAVED_EMBEDDINGS_SOCIAL_DIR = os.path.join(SAVED_EMBEDDINGS_DIR, "SOCIAL")
